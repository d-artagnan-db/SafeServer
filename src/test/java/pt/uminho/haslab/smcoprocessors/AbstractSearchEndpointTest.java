...
public abstract class AbstractSearchEndpointTest {
    ...
    AbstractSearchEndpointTest() throws Exception {
    ...
    public void search() throws Throwable {
        ...
        LOG.debug("Creating table " + getTestTableName() + " with family " + secretFamily);
        ...
        for (int i = 0; i < values.size(); i++) {
            ...
            LOG.debug("Value to share is " + value + " bitLength " + value.bitLength());
