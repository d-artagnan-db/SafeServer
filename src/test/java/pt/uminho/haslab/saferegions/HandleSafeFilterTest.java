...
import pt.uminho.haslab.saferegions.secretSearch.ComposedSearchValue;
import pt.uminho.haslab.saferegions.secretSearch.SearchCondition;
import pt.uminho.haslab.saferegions.secretSearch.SearchValue;
import pt.uminho.haslab.saferegions.secretSearch.UnarySearchValue;
...
import static pt.uminho.haslab.saferegions.secretSearch.SearchCondition.Condition.And;
import static pt.uminho.haslab.saferegions.secretSearch.SearchCondition.Condition.Or;
...
public class HandleSafeFilterTest {
    ...
    public void testSCVFWhileMatch() {
        ...
        HandleSafeFilter sfh = new HandleSafeFilter(getTableSchema(), null, null);
